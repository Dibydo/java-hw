...
public class Test {
    public static void main(String[] args) {
        ...
        TopManager tManager1 = new TopManager("Максим");
        TopManager tManager2 = new TopManager("Евгений");
        TopManager tManager3 = new TopManager("Егор");
        ...
        System.out.println("Company income: " + BMSTU.getIncome());
